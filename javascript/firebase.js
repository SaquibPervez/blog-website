 ...
 import { doc, setDoc, getFirestore, getDoc,addDoc,collection,getDocs, updateDoc,deleteDoc,query, where } from "https://www.gstatic.com/firebasejs/11.1.0/firebase-firestore.js";
...
const db = getFirestore(app);
 ...
 export{
    ...
    auth,doc, setDoc, getDoc , db , onAuthStateChanged,addDoc,collection,getDocs,updateDoc,deleteDoc,query, where
 }